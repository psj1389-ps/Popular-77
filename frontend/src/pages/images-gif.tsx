...
const ImagesGifPage: React.FC = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      const res = await fetch('/api/images-gif', { method: 'POST', body: form });
      if (!res.ok) {
          ...
          <div className="container mx-auto relative z-10">
            <div className="flex justify-center items-center gap-4 mb-4">
              <h1 className="text-4xl font-bold">
                ...
                Image(JPG, PNG, WEBP, BMP, TIFF, SVG, PSD, HEIC, RAW) → GIF 변환기
              </h1>
            </div>
            <p className="text-lg opacity-90 max-w-2xl mx-auto">JPG, PNG, WEBP, BMP, TIFF, SVG, PSD, HEIC, RAW 이미지를 애니메이션 GIF로 변환합니다.</p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="bg-white p-8 rounded-xl shadow-lg max-w-2xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-semibold text-gray-800">Image → GIF 변환기</h2>
              <p className="text-gray-500">다양한 이미지 형식을 애니메이션 GIF로 변환 (JPG/PNG/WEBP/BMP/TIFF/SVG/PSD/HEIC/RAW → GIF)</p>
            </div>
            ...
            {!selectedFile ? (
              <label htmlFor="file-upload" className="block border-2 border-dashed border-gray-300 rounded-lg p-10 text-center cursor-pointer hover:border-blue-500 hover:bg-gray-50 transition-colors">
                <input id="file-upload" ref={fileInputRef} type="file" accept=".jpg,.jpeg,.png,.webp,.bmp,.tiff,.svg,.psd,.heif,.heic" onChange={handleFileChange} className="hidden" />
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <label className="flex items-center p-3 border rounded-lg">
                      <input type="radio" name="format" value="gif" checked readOnly className="w-4 h-4 text-blue-600 mr-3" />
                      <div className="flex-1"><span className="font-medium">🎞️ GIF - 애니메이션 지원, 웹 호환성</span></div>
                    </label>
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto mt-16">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">이미지를 GIF로 변환하는 방법</h2>
            <p className="text-center text-gray-600 mb-12">간단한 4단계로 다양한 이미지를 애니메이션 GIF로 변환하세요</p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">JPG, PNG, WEBP, BMP, TIFF, SVG, PSD, HEIC, RAW 등 파일을 업로드하세요.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-lg mb-2">품질/크기 선택</h3>
                <p className="text-gray-600">변환 품질과 이미지 크기를 선택해 최적화하세요.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-lg mb-2">자동 변환 시작</h3>
                <p className="text-gray-600">"변환하기" 버튼을 클릭하면 엔진이 GIF로 변환합니다.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-lg mb-2">GIF 다운로드</h3>
                <p className="text-gray-600">변환 완료 후 GIF 파일을 바로 다운로드합니다.</p>
              </div>
            </div>
          </div>
        </div>
